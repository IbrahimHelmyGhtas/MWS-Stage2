...
document.getElementById("restaurantimg").addEventListener('click', (event) => {
...
const currentRate =document.getElementById("RateSelect").value;
...
fetchRestaurantFromURL = (callback) => {
  ...
  if (!id) { // no id found in URL
    ...
    DBHelper.fetchRestaurantById(id, (error, restaurant) => {
      ...
      document.getElementById("restaurantimg").src = "img/rest"+id + ".webp";
